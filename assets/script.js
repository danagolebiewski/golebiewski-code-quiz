class GameState {
    ...
    this.questions = [
      {
        num: 1,
        question:
          "What is the player called that scores points in roller derby?",
        answer: "answer1",
        options: ["jammer", "blocker", "pivot", "baddie"],
      },
      {
        num: 2,
      ...
      },
      {
        num: 3,
        question:
          "How many penalties can you receive before fouling out of the game?",
        answer: "answer4",
        options: ["3", "9", "5", "7"],
      },
      {
      ...
      },
      {
        ...
        answer: "answer1",
        options: ["pivot", "blocker", "opposing jammer", "coach"],
      },
    ];
  ...
  updateTimer() {
    ...
    if (this.state == "RUNNING" && this.secondsRemaining > 0) {
  ...
  viewHighScores() {
    ...
    this.highscores.forEach((currentValue) => {
      highscoresHTML +=
